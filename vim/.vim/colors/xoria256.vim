...
hi LineNr       ctermfg=247 guifg=#9e9e9e ctermbg=none guibg=#101010
...
hi SpellBad     ctermfg=160 guifg=fg      ctermbg=bg                cterm=none      guisp=#df0000
...
hi Constant     ctermfg=140  guifg=#ffffaf
